...
const stats = [
  ...
  { label:"Focus", value: "Backend Development & APIs"},
...
const glows = [
  "-top-10 -left-10 w-[360px] h-[360px] opacity-20 blur-[12px]",
  ...
  return(
    ...
    >
      ...
      rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-[#1cd8d2]/20 to-[#302b63]/20 border-[#1cd8d2]/25
          ...
          transition={{type:'spring', stiffness:200 , dampning:20}}
          >
      ...
      <div className="flex-1 flex flex-col justify-center text-center md:text-left">
        ...
        bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] to-[#1cd8d2]">
          ...
          <p className='mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl'>
            ...
            I love turning ideas into reality using code and am always eager to learn new technologies and improve my skills.
          </p>
    ...
    >
      ...
      <p className='text-gray-300 leading-relaxed text-base sm:text-lg'>
        I'm a dedicated Full Stack Developer with a passion for crafting dynamic and responsive web applications. With a strong foundation in both front-end and back-end technologies, 
        I thrive on turning complex problems into elegant solutions. My journey in web development is fueled by a relentless curiosity and a commitment to continuous learning. I enjoy collaborating with teams to bring innovative ideas to life and am always eager to embrace new challenges that push the boundaries of my skills.
      </p>
