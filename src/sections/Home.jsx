...
const socials =[
  {Icon : FaLinkedin , label: "LinkedIn", url: "https://www.linkedin.com/in/rithish-r-achar-46181334a/"},
  {Icon : FaGithub , label: "GitHub", url: "https://github.com/rithishrachar"},
  {Icon : FaInstagram , label: "Instagram", url: "https://www.instagram.com/rithish_r_acharya_?igsh=Ync4ZnR1bGc3NnJz"}
]
...
const glowVariants = {
  ...
  tap : {scale : 0.5, y:0, transition:{ duration:0.08}}
}

export default function Home(){
const roles = useMemo(() =>["Full Stack Developer", "Web Developer", "Software Developer"],[])
  ...
  return(
    ...
    id="home" className="w-full h-screen relative bg-black overflow-hidden">
      ...
      <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
        ...
        <motion.p className="mt-6 text-lg sm:text-xl md:text-2xl text-gray-300 max-w-2xl mx-auto lg:mx-0"
        initial={{opacity:0, y:20}}
        animate={{opacity:1, y:0}}
        transition={{duration:0.8, delay:0.4}}
        >
          I'm a passionate developer specializing in creating dynamic and beautiful web applications. Welcome to my portfolio!
        ...
        <div className="mt-10 flex - gap-5 text-2xl md:text-3xl justify-center lg:justify-start">
          ...
          <div className=" relative hidden lg:block">
            ...
            />
          <motion.img src={avatar} alt="Rithish R Achar"
